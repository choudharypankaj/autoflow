...
from app.api.admin_routes.prometheus import router as admin_prometheus_router
from app.api.admin_routes.prometheus_hosts import router as admin_prometheus_hosts_router
...
api_router.include_router(admin_prometheus_router, tags=["admin/prometheus"])
api_router.include_router(admin_prometheus_hosts_router, tags=["admin/prometheus"])
