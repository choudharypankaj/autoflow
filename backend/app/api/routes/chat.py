...
class ChatRequest(BaseModel):
    ...
    stream: bool = True
    # optional: allow the client to hint which MCP agent to use
...
def chats(
    ...
    try:
        # Read preferred MCP agent from header or body
        mcp_host_name = request.headers.get("X-MCP-Host-Name") or chat_request.mcp_host_name
